...
public class NewsTitleTests
{
    ...
    internal void Should_create_new_keyword_title_when_calling_create_instance_method()
    {
        ...
        var keywordTitle = NewsTitle.CreateInstance(title);
    ...
    {
        // exercise
        var nullAct = () => NewsTitle.CreateInstance(null!);
        var whitespaceAct = () => NewsTitle.CreateInstance("");
    ...
    internal void Should_throw_exception_when_length_of_title_value_is_greater_than(int length)
    {
        ...
        // exercise
        var act = () => NewsTitle.CreateInstance(title);
